...
namespace SoftWareDesign.Dal
{
    ...
    public abstract class SqlHelp
    {
        ...
        //public static string connectionString = System.Configuration.ConfigurationManager.AppSettings["sql"];

        public static string connectionString = "server=39.105.55.85,1433; database=PaperCheck; uid=sa;pwd=123qwe..";
