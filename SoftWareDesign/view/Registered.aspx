<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registered.aspx.cs" Inherits="SoftWareDesign.view.Registered" %>
    ...
    <header class="top">
        ...
        <div class="top_con">
            ...
            <div class="topbtn pull-right">
                ...
                <a href="Registered.html" class="btn_sign">注册</a>
            </div>
                ...
                <form id="w0" class="sign-form" action="/signup" method="post">
                    ...
                    <div class="form-group field-signupform-username required">
                        <div class="form-group">
                            <label class="control-label" for="signupform-username">用户名</label><p class="help-block help-block-error"></p>
                            <input type="text" id="signupform-username" class="form-control" name="SignupForm[username]">
                        </div>
                        <p style="color: #F06541; font-size: 12px; margin-top: -10px;">用户名仅允许使用英文字母、数字、下划线[ _ ]</p>
                    </div>
                    <div class="form-group field-signupform-password required">
                        <div class="form-group">
                            <label class="control-label" for="signupform-password">密码</label><p class="help-block help-block-error"></p>
                            <input type="password" id="signupform-password" class="form-control" name="SignupForm[password]">
                        </div>
                    </div>
                    <div class="form-group field-signupform-password_repeat required">
                        <div class="form-group">
                            <label class="control-label" for="signupform-password_repeat">密码确认</label><p class="help-block help-block-error"></p>
                            <input type="password" id="signupform-password_repeat" class="form-control" name="SignupForm[password_repeat]">
                        </div>
                    </div>
                    <div class="form-group field-signupform-email required">
                        <div class="form-group">
                            <label class="control-label" for="signupform-email">邮箱</label><p class="help-block help-block-error"></p>
        ...
        <div class="modal-dialog">
            <div class="modal-content mengcommit">
                ...
                <div class="modal-body mymod-body">
                    ...
                    <p>5. 5 中工系统只能用户本人进行使用，如利用该系统在任何电子商务平台进行赢利，本网站有追究其法律责任的权利。 </p>
                    <h4>六、其他 </h4>
